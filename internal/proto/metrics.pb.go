...
const file_api_metrics_v1_metrics_proto_rawDesc = "" +
	"\n" +
	"\x1capi/metrics/v1/metrics.proto\x12\ametrics\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB\"Z metrics-collector/internal/protob\x06proto3"
