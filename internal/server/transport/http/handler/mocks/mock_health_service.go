...
// Source: metrics-collector/internal/server/transport/http/handler (interfaces: HealthService)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_health_service.go -package=mocks . HealthService
//
