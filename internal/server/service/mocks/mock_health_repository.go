...
// Source: metrics-collector/internal/server/service (interfaces: HealthRepository)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_health_repository.go -package=mocks . HealthRepository
//
